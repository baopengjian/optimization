...
public class ChatAdapter extends ArrayAdapter<Chat> {
    ...
    public ChatAdapter(boolean optimization, Context context, ArrayList<Chat> chats) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            if (optimization) {
                view = LayoutInflater.from(getContext()).inflate(R.layout.chat_item_opt, parent, false);
            } else {
